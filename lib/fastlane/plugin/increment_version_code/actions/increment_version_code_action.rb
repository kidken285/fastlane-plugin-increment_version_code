    ...
    class IncrementVersionCodeAction < Action
      def self.run(params)
        ...
        if gradle_file_path != nil
            ...
            new_version_code = incrementVersion(gradle_file_path, new_version_code, constant_name, product_flavor, foundProductFlavor)
        else
            ...
            Dir.glob("**/#{app_folder_name}/build.gradle") do |path|
                ...
                new_version_code = incrementVersion(path, new_version_code, constant_name, product_flavor, foundProductFlavor)
            end
      ...
      def self.incrementVersion(path, new_version_code, constant_name, product_flavor, foundProductFlavor)
          if !File.file?(path)
